        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                {...register("name")}
                className="input text-xs bg-white text-slate-900 font-medium border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  {...register("sku")}
                  className="input text-xs bg-white text-slate-900 font-mono font-semibold border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            ...
            <div>
              ...
              <select
                {...register("categoryId")}
                className="input text-xs bg-white text-slate-900 font-medium border-slate-300 focus:border-blue-500"
              >
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">Selling Price (PKR) *</label>
              <input
                type="number"
                step="0.01"
                {...register("sellingPrice", { valueAsNumber: true })}
                className="input text-xs bg-white text-slate-900 font-mono font-bold border-slate-300 focus:border-blue-500"
              />
              {errors.sellingPrice && <p className="mt-1 text-xs text-rose-600">{errors.sellingPrice.message}</p>}
            </div>

            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">Minimum Stock Level Alert *</label>
              <input
                type="number"
                step="0.01"
                {...register("minStockLevel", { valueAsNumber: true })}
                className="input text-xs bg-white text-slate-900 font-mono font-semibold border-slate-300 focus:border-blue-500"
              />
          ...
          <div>
            ...
            <textarea
              ...
              className="input text-xs bg-white text-slate-900 border-slate-300 min-h-[80px]"
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            <label htmlFor="isActive" className="text-xs font-semibold text-slate-800">
              Active Product (Visible in POS Terminal)
            </label>
          </div>
